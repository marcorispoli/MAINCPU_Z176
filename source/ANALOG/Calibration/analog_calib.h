...
#define _DEF_COLLI_CALIB_FORMAT_MAG_18x24       4
#define _DEF_COLLI_CALIB_FORMAT_MAG_24x30       5
#define _DEF_COLLI_CALIB_FORMAT_MIRROR          6
#define _DEF_COLLI_CALIB_FORMAT_FACTORY         7
