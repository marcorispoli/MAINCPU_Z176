...
)
{
    ...
    defined(BSP_SVF522REVB_A5)
            index = GIC_FlexCAN0;
#elif defined(BSP_VYBRID_AUTOEVB_M4) || defined(BSP_TWR_VF65GS10_M4) || \
      defined(BSP_SVF522REVB_M4)
            index = NVIC_FlexCAN0;
#else
            switch (vector_type)
            {
...
#if !(defined(BSP_VYBRID_AUTOEVB_M4) || defined(BSP_VYBRID_AUTOEVB_A5) || \
      defined(BSP_SVF522REVB_A5) || defined(BSP_TWR_VF65GS10_M4) || \
      defined(BSP_TWR_VF65GS10_A5) || defined(BSP_SVF522REVB_M4))
/*!
